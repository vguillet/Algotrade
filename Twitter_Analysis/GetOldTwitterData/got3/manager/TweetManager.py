    ...
    def getTweets(tweetCriteria, receiveBuffer=None, bufferLength=100, proxy=None):
        ...
        while active:
            ...
            for tweetHTML in tweets:
                ...
                tweet.formatted_date = datetime.datetime.isoformat(tweet.date)
                ...
                if tweetCriteria.maxTweets > 0 and len(results) >= tweetCriteria.maxTweets:
                    active = False
                    break
                completion = len(results) / tweetCriteria.maxTweets
                time_left = int((time() - t) / completion - time() + t)
                ...
                print("\r", int(100 * completion), "% completed, time left to complete fetching for this day:",
                      time_string, end='')
    ...
    def getJsonReponse(tweetCriteria, refreshCursor, cookieJar, proxy):
        ...
        if hasattr(tweetCriteria, 'topTweets'):
            if tweetCriteria.topTweets:
                url = "https://twitter.com/i/search/timeline?q=%s&src=typd%s&max_position=%s"
